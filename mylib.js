...
const app = new Vue({
        ...
        data: {
			...
			WebApiUrl: 'http://peterxie.azurewebsites.net/api/DINDONC',
            rdoMemType: 'Member',
            M_Name: null,
            M_Password: null,
            errors: [],
        ...
        methods: {
            ...
            NewDinRequest: function () {
                this.LodingFlag = true;
                fetch('https://localhost:44342/api/DINDONC/member', {
                    method: 'POST',
                    // headers 加入 json 格式
                    headers: {
                        'Content-Type': 'application/json'
            ...
            CheckGID: function () {
                ...
                fetch('https://localhost:44342/api/DINDONC/' + this.SecondPageGroup.GID, {
                    method: 'GET',
                    // headers 加入 json 格式
                    headers: {
                        'Content-Type': 'application/json'
